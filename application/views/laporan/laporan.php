...
<table><tr>
		...
		<tr>
		<td>Kelas</td><td><select name="kelas" id="kelas" class="kelas"><option value="">--Pilih Kelas--</option></select></td>
</table>
<br>
<div id="data">
</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var mapel=$(".mapel").val();
		var kelas=$(".kelas").val();
		$.post('<?php echo base_url().'index.php/laporan/show_kelas/'; ?>'+mapel,{mapel:mapel},function(kelasnya) {
				$('#kelas').html(kelasnya);
			});
		$.post('<?php echo base_url().'index.php/laporan/keluar_tabel/-/-'; ?>',{mapel:mapel},function(tabelnya) {
				$('#data').html(tabelnya);
			});
		...
		$("#kelas").change(function() {
			var mapel=$(".mapel").val();
			var kelas=$(".kelas").val();
		$.post('<?php echo base_url().'index.php/laporan/keluar_tabel/'; ?>'+mapel+'/'+kelas,{mapel:mapel},function(tabelnya) {
				$('#data').html(tabelnya);
			});
		});
	});
